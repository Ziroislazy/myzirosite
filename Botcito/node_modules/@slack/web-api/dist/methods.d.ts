...
export declare abstract class Methods extends EventEmitter<WebClientEvent> {
    ...
    readonly blocks: {
         ...
         */
        validate: MethodWithOptionalArgument<BlocksValidateArguments, BlocksValidateResponse>;
    };
    readonly bots: {
        /**
