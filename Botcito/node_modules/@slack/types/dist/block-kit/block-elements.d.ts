import type { RichTextBlock } from '@slack/types/src/block-kit/blocks';
import type { ColorScheme, Option, PlainTextElement, PlainTextOption, SlackFileImageObject, UrlImageObject } from '@slack/types/src/block-kit/composition-objects';
import type { Actionable, Confirmable, Dispatchable, Focusable, MaxItemsSelectable, Placeholdable, RichTextBorderable, RichTextStyleable, URLRespondable } from '@slack/types/src/block-kit/extensions';
/**
